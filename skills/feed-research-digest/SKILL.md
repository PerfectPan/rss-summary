...
4. Research only the top candidates that are plausibly useful. Prefer 5 to 8 items unless the user asks for more.
...
```bash
GH_FEED_TOKEN="..." GITHUB_USERNAME=PerfectPan RSS_FEEDS_FILE=feeds.json npm run --silent digest -- --only-new
```
